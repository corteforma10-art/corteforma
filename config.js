...
const siteConfig = {
  ...
  "products": [
    ...
    },
    {
      ...
      "image": "https://i.imgur.com/2ARQ5ql.jpeg",
      "tags": [
        "Mdf",
        "Laser"
      ],
  ...
  "features": [
    {
      ...
      "description": "Cada produto é feito sob medida, com seu nome, logo ou ideia."
    },
    {
      "icon": "⚙️",
      "title": "Fabricação sob demanda",
      "description": "Produzimos a partir do seu pedido, sem estoque parado."
    },
    {
      "icon": "🏅",
      "title": "Acabamento cuidadoso",
      "description": "Atenção aos detalhes em cada peça, do corte à embalagem."
    },
    {
      "icon": "🖨️",
      "title": "Tecnologia de ponta",
      "description": "Impressão 3D, resina, laser e CNC para resultados precisos."
    },
    {
      "icon": "🎁",
      "title": "Brindes e presentes",
      "description": "Ideias únicas para eventos, empresas e datas especiais."
    },
    {
      "icon": "💬",
      "title": "Atendimento direto",
      "description": "Converse com a equipe pelo WhatsApp e tire todas as dúvidas."
    }
  ],
  "howToBuy": {
    "title": "Como comprar",
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": "Toque em \"Comprar pelo WhatsApp\" no card do produto."
      },
      {
        "number": "03",
        "title": "Informe os detalhes",
        "description": "Envie nome, cor, texto ou qualquer personalização desejada."
      },
      {
        "number": "04",
        "title": "Receba o orçamento",
        "description": "Nossa equipe responde rapidamente com valor e prazo."
      },
      {
        "number": "05",
        "title": "Combine tudo",
        "description": "Acerte produção, pagamento e forma de entrega ou retirada."
      }
    ]
  },
  "custom": {
